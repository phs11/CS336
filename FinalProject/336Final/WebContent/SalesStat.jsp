...
<table cellpadding="0" cellspacing="0" border="0" width="100%">
	...
	<table>
		...
		try {
			...
			String str = "select B.username, S.price, A.companyName, A.description From Advertisement A, Buys B, Sale_Item S Where S.AD_ID = B.AD_ID and B.AD_ID = A.AD_ID";
			ResultSet result = stmt.executeQuery(str);
			%>
		<h2>Items Sold</h2>
		<a href="TopSelling.jsp">Top selling items</a>
		<table border="1">
			<tr>
			...
			while(result.next()){
				%>
			<tr>
				<td align="center" valign="middle" width="300"><a href="SalesUser.jsp?user=<%=result.getString("username") %>"><%=result.getString("username") %></a></td>
				<td align="center" valign="middle" width="300"><a href="SalesCompany.jsp?company=<%=result.getString("companyName") %>"><%=result.getString("companyName") %></a></td>
