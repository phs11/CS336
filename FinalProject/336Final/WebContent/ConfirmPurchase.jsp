...
try { //Create a connection string
	...
	String ad = "select * from Advertisement where AD_ID = " + request.getParameter("ad");
	ResultSet result1 = stmt1.executeQuery(ad);
	result1.next();
	String username = session.getAttribute("userName").toString();
	String desc = result1.getString("description");
	String insert = "Insert into Buys(AD_ID,username,description) values(?,?,?)";
	PreparedStatement ps = con.prepareStatement(insert);
	//Add parameters of the query. Start with 1, the 0-parameter is the INSERT statement itself
	ps.setString(1, request.getParameter("ad"));
