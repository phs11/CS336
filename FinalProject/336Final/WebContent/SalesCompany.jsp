...
<table cellpadding="0" cellspacing="0" border="0" width="100%">
	...
	<table>
			...
			<br>
		<h2>Sales to Company:<br><i><%=company%></i></h2><br>
		<table border="1">
			<tr>
		...
		try {
			...
			String str = "select B.username,S.price, A.description From Advertisement A, Buys B, Sale_Item S Where S.AD_ID = B.AD_ID and B.AD_ID = A.AD_ID and A.companyName = '" + company + "'";
			ResultSet result = stmt.executeQuery(str);
			while(result.next()){
				%>
				<tr>
					<td align="center" valign="middle" width="300"><%=result.getString("username") %></td>
