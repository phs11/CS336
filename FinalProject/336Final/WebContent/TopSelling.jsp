...
<table cellpadding="0" cellspacing="0" border="0" width="100%">
	...
	<table>
		...
		try {
			...
			String str = "select B.description, S.price, A.companyName, count(AD_ID) count from ((Buys B join Advertisement A using (AD_ID)) join Sale_Item S using (AD_ID)) Group by(AD_ID) order by count DESC";
			ResultSet result = stmt.executeQuery(str);
			%>
		<h2>Top Selling Items:</h2>
		<table border="1">
			<tr>
				<td align="center" valign="middle" width="200">Company</td>
				<td align="center" valign="middle" width="300">Description</td>
				<td align="center" valign="middle" width="100">Price</td>
				<td align="center" valign="middle" width="100"># sold</td>
			</tr>
			<%
			while(result.next()){
				%>
			<tr>
				<td align="center" valign="middle" width="200"><%=result.getString("companyName") %></td>
				<td align="center" valign="middle" width="300"><%=result.getString("description") %></td>
				<td align="center" valign="middle" width="100">$<%=result.getString("price") %></td>
				<td align="center" valign="middle" width="100"><%=result.getString("count") %></td>
			</tr>
			<% 
			}
			%>
		</table>
		<a href="SalesStat.jsp">Back to Statistics</a>
	</center>
	<%
