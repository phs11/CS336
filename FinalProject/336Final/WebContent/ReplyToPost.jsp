...
<form method="post" action="MakeReplyConfirm.jsp">
      <p>
        <strong>Reply Response</strong>
        <input type="text" size="200" name="postContent" value= "Enter your reply here">
        </p>
         <p>
