...
try{
	...
	String str = "SELECT * FROM Advertisement where AD_ID = "+adID;
...
<h2>Edit Advertisement:</h2>
	<br>
	<form method="post" action="AdCheck.jsp?ad=<%=adID%>">
		<table>
			<tr>
				<td>Company Name</td>
			...
			<tr>
				<td>Key words</td>
				<td><textarea name="keywords" cols="40" rows="2"><%=keywords%></textarea></td>
			</tr>
		</table>
		<input type="submit" value="Update"><button type="button" onclick="location.href='DeleteAd.jsp?ad=<%=adID%>'">Delete Ad</button><button type="button" onclick="location.href='ManageAds.jsp'">Cancel</button>
	</form>
