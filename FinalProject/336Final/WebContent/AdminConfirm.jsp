	...
	<center>
		...
		try{
			...
			if(request.getParameter("option") == null){
			 ...
			 if(request.getParameter("option").equalsIgnoreCase("remove")){ //remove moderator
					deleteCount = stmt.executeUpdate("Delete from Moderator WHERE username= '" + selected + "'");
					System.out.println("Delete from Moderator WHERE username='" + selected + "'");
					%>
					<jsp:forward page="AdminHome.jsp">
						<jsp:param name="userName" value="<%=userName %>" />
					</jsp:forward>
					<%
			 }else if(request.getParameter("option").equalsIgnoreCase("make")){ //make moderator
				str = "Insert into Moderator values('" + userName + "')";
				System.out.println(str);
				deleteCount = stmt.executeUpdate("Insert into Moderator values('" + selected + "')");
				%>
				<jsp:forward page="AdminHome.jsp">
					<jsp:param name="userName" value="<%=userName %>" />
				</jsp:forward>
				...
				deleteCount = stmt.executeUpdate("Delete from User where username ='" + selected + "'");
				System.out.println("Delete from User where username = '" + selected + "'");
				%>
				<jsp:forward page="AdminHome.jsp">
					<jsp:param name="userName" value="<%=userName %>" />
				</jsp:forward>
				<%
			 }else if(request.getParameter("option").equalsIgnoreCase("hire")){ // make sales_staff
				 deleteCount = stmt.executeUpdate("Insert into Sales_Staff values('" + selected + "')");
				 %>
					<jsp:forward page="AdminHome.jsp">
						<jsp:param name="userName" value="<%=userName %>" />
					</jsp:forward>
				<%
			 }else if(request.getParameter("option").equalsIgnoreCase("fire")){ //remove sales_staff
				 deleteCount = stmt.executeUpdate("Delete from Sales_Staff where username ='" + selected + "'");
				 %>
					<jsp:forward page="AdminHome.jsp">
						<jsp:param name="userName" value="<%=userName %>" />
					</jsp:forward>
