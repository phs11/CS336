...
/*
Modify an threadname or location inside of a topic
...
String topicName = (String)request.getParameter("topicName");
	...
	try{
		...
		String str = "SELECT P.description FROM Thread P WHERE P.threadID = '"+threadID+"'";
		
		System.out.println(str + "in EditTopic");
...
<form method="post" action="EditThreadConfirm.jsp?topicName=<%=topicName%>&threadID=<%=threadID%>">
      <p>
        <strong>Edit Content</strong>
        <input type="text" size="100" name="postContent" value= "<%=description %>">
        </p>
         <p>
