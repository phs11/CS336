...
<!-- End of Top Navigation -->
	...
	<center>
		...
		<table border="1">
			<tr>
				<td align="center" valign="middle" width="300">Username</td>
				<td align="center" valign="middle" width="300">Moderator</td>
				<td align="center" valign="middle" width="300">Sales Staff</td>
			</tr>
			<%
				str = "SELECT * from User where NOT (userName = 'admin')";
					result = stmt.executeQuery(str);
					ResultSet result2;
					Statement stmt2 = con.createStatement();
					String userID;
					while (result.next()) {
						System.out.println("User is : " + result.getString("userName"));
						userID = result.getString("username");
						System.out.println(userID);
						str = "SELECT M.username from Moderator M WHERE M.username = '" + userID + "'";
						result2 = stmt2.executeQuery(str);
						if(result2.next()){ //is moderator
							%>
			<tr>
				<td align="center" valign="middle" width="300"><a
					href="AdminChoose.jsp?selected=<%=userID%>"><%=userID%></a></td>
				<td align="center" valign="middle" width="300">Yes</td>
				<td align="center" valign="middle" width="300">No</td>
			</tr>
			<%
						}else{ //not moderator
							str = "Select S.username from Sales_Staff S where S.username ='" + userID + "'";
							result2 = stmt2.executeQuery(str);
							if(result2.next()){ //is sales_Staff
								%>
			<tr>
				<td align="center" valign="middle" width="300"><a
					href="AdminChoose.jsp?selected=<%=userID%>"><%=userID%></a></td>
			...
			<%
							}else{ //neither moderator or sales_staff
								%>
			<tr>
				<td align="center" valign="middle" width="300"><a
					href="AdminChoose.jsp?selected=<%=userID%>"><%=userID%></a></td>
