...
<center>
	...
	%>
	<br>
	<a href="MakeTopic.jsp">Make a New Topic</a>
	<%
...
try{
	...
	String topicName = result.getString("topicName");
		...
		%>
	<div id="container">
		<%=topicName.toUpperCase() %>: <br> 
		
		<br> <a href="IndividualTopic.jsp?topicName=<%=topicName%>">Go
			to <%=topicName%> threads
		</a>
		...
		<%
			//check if they can modify links
					if(userType.equals("Admin"))
					{
						%>
						<br>
						<a href="ModifyTopic.jsp?modType=d&topicName=<%=topicName%>">Delete Topic</a>
						&nbsp;&nbsp;
						<a href="ModifyTopic.jsp?modType=e&topicName=<%=topicName%>">Edit Topic</a>
