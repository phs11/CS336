...
<center>
<h2>Edit your profile: <%=session.getAttribute("userName")%></h2>
<br>
<br>
...
<table>
			<tr>
				...
				<td align="center" valign="middle" width="200"><a
					href="EditGoHome.jsp">Edit Profile Information</a></td>
				<td align="center" valign="middle" width="200"><a
					href="index.jsp"
	...
	try{
		...
		String str = "SELECT U.bio FROM User U WHERE U.username = '"+userName+"'";
		...
		String q2 = "SELECT U.profilePicUrl FROM User U WHERE U.username = '"+userName+"'";
		...
		picUrl = result2.getString("profilePicUrl");
...
<form method="post" action="UpdateProfile.jsp">
      <p>
        ...
        <input type="text" size="50" name="profilePicUrl" value= "<%=picUrl %>">
        </p>
        <p>
        <strong>Bio</strong>
        <input type="text" size="100" name="bio" value= "<%=bio %>">
      </p>
